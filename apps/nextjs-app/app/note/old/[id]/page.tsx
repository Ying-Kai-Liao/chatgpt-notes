          ...
          <CardContent className="p-6" id="note-content">
            ...
            {viewMode === 'preview' && (
              <div className="prose max-w-none">
                <div className="bg-background p-6 sm:p-8 rounded-lg space-y-4 [&_pre]:overflow-x-auto [&_pre]:whitespace-pre-wrap [&_code]:break-words [&_code]:whitespace-pre-wrap [&_table]:border-collapse [&_table]:w-full [&_th]:border [&_th]:border-gray-300 [&_th]:p-2 [&_td]:border [&_td]:border-gray-300 [&_td]:p-2 [&_h1]:break-words [&_h2]:break-words [&_h3]:break-words [&_h4]:break-words [&_h5]:break-words [&_h6]:break-words [&_p]:break-words [&_pre_code]:text-zinc-800 dark:[&_pre_code]:text-zinc-200 [&_code]:text-zinc-800 dark:[&_code]:text-zinc-200">
                  <ReactMarkdown
